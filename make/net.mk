...
host-mdb-emulated-external-test: ## Add MariaDB test hosts to /etc/hosts.
	@./hack/add_host.sh 47 mdb-emulate-external-test.default.svc.cluster.local
...
host-mariadb-repl-ext-multi-schema: ## Add mariadb-repl-ext-multi-schema hosts to /etc/hosts.
	@./hack/add_host.sh 195 mariadb-repl-ext-multi-schema.default.svc.cluster.local
	@./hack/add_host.sh 196 mariadb-repl-ext-multi-schema-primary.default.svc.cluster.local
	@./hack/add_host.sh 197 mariadb-repl-ext-multi-schema-secondary.default.svc.cluster.local
	@./hack/add_host.sh 198 mariadb-repl-ext-multi-schema-0.mariadb-repl-ext-multi-schema-internal.default.svc.cluster.local
	@./hack/add_host.sh 199 mariadb-repl-ext-multi-schema-1.mariadb-repl-ext-multi-schema-internal.default.svc.cluster.local
	@./hack/add_host.sh 202 mariadb-repl-ext-multi-schema-2.mariadb-repl-ext-multi-schema-internal.default.svc.cluster.local
	@./hack/add_host.sh 203 mariadb-repl-ext-multi-schema-3.mariadb-repl-ext-multi-schema-internal.default.svc.cluster.local
